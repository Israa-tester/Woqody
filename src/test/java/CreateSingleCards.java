...
public class CreateSingleCards {
    ...
    public void CreateVehicleCard() throws InterruptedException
    {
        ...
        Thread.sleep(2000);
        Cards.CardStock(dashAdmin.driver).sendKeys(Keys.ARROW_DOWN);
        Cards.CardStock(dashAdmin.driver).sendKeys(Keys.ENTER);
        Cards.CardLabel(dashAdmin.driver).sendKeys("AutoSingleCardTest");
    ...
    public void CreateEmployeeCard() throws InterruptedException
    {
        ...
        Thread.sleep(2000);
        Cards.CardStock(dashAdmin.driver).sendKeys(Keys.ENTER);
        Cards.CardLabel(dashAdmin.driver).sendKeys("AutoSingleEmployee");
        Cards.CardCurrency(dashAdmin.driver).sendKeys("Saudi");
        Cards.CardCurrency(dashAdmin.driver).sendKeys(Keys.ENTER);
        Cards.CardUser(dashAdmin.driver).click();
        Cards.CardUser(dashAdmin.driver).sendKeys(Keys.ENTER);
