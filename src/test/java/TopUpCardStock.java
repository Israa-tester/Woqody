...
public class TopUpCardStock extends BeforeAndAfter {
    ...
    public void TopupVehicleStock()
    {
        ...
        WebElement element = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//td[.='CardsV - 353 - 1']//parent::tr//button[3][@type='button']")));
        ((JavascriptExecutor)dashAdmin.driver).executeScript("arguments[0].click();", element);
        /////////////////////////////////////////////////////////////////////////
        CardStockPage.TopupFile(dashAdmin.driver).sendKeys("C:\\Users\\ag\\Desktop\\stock_CardsV.csv");
    ...
    public void TopupEmployeeStock()
    {
        ...
        WebDriverWait wait = new WebDriverWait(dashAdmin.driver, Duration.ofSeconds(10));
        WebElement element = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//td[.='CardsEmp - 353 - 2']//parent::tr//button[3][@type='button']")));
        ((JavascriptExecutor)dashAdmin.driver).executeScript("arguments[0].click();", element);
        /////////////////////////////////////////////////////////////////////////
        CardStockPage.TopupFile(dashAdmin.driver).sendKeys("C:\\Users\\ag\\Desktop\\stock_CardsEmp.csv");
